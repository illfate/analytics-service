...
// Source: internal/analytics/event.go
...
func (mr *MockRepositoryMockRecorder) InsertEvents(ctx interface{}, events ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx}, events...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "InsertEvents", reflect.TypeOf((*MockRepository)(nil).InsertEvents), varargs...)
}
